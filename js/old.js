...
import { convertMillisecondsToISO8601Duration, getBaseUrl, getActivityType, getLearnerInfo, processInteractionResponse, showErrorNotification, stripHtml } from './Helpers'
...
class XAPI extends Backbone.Model {
  ...
  async initialize() {
    ...
    this.set({
      activityId: (this.getLRSAttribute('activity_id') || this.getConfig('_activityID') || getBaseUrl()),
